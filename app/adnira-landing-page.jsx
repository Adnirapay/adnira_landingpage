          ...
          <div className="grid md:grid-cols-2 gap-16 items-center">
            ...
            <div className="relative">
              <div className="aspect-[4/3] rounded-2xl overflow-hidden border border-slate-800 shadow-2xl">
                <img 
                  src="/images/adnira.png"
                  alt="PT Adnira Dalil Anugrah - Transportasi, Pengembangan Aplikasi, Payment Point"
                  className="w-full h-full object-cover"
                  onError={(e) => {
                    // Fallback if image not found
                    e.target.style.display = 'none';
                    e.target.parentElement.innerHTML = `
                      <div class="w-full h-full flex items-center justify-center bg-gradient-to-br from-blue-900/50 to-red-900/50 backdrop-blur-sm">
                        <div class="text-center p-8">
                          <div class="w-24 h-24 bg-gradient-to-br from-blue-500 to-red-600 rounded-2xl mx-auto mb-4 flex items-center justify-center">
                            <span class="text-5xl font-black">A</span>
                          </div>
                          <p class="text-slate-400 text-sm">Company Image Placeholder</p>
                          <p class="text-slate-500 text-xs mt-2">Upload: public/images/adnira.png</p>
                        </div>
                      </div>
                    `;
                  }}
